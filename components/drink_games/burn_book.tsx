...
//   const roundResults = state?.roundResults || null;
...
//                 const isSelected = state?.myVote === player.id; // Optional: if server reflects myVote
//                 const displayName = player.username || player.name || "Unknown";
//                 const initial = displayName[0] || "?";

//                 // In this new engine, hasVoted disables buttons to wait for timer
//                 return (
//                   <TouchableOpacity
//                     key={player.id}
//                     onPress={() => handleVote(player.id)}
//                     disabled={state?.hasVoted} // Disable if already voted this round
...
//           <Text className="text-white/50 text-center text-sm px-6 mb-8 font-medium italic">
//             "{currentQuestionText}"
//           </Text>

//           <View className="items-center mb-10">
//             <Text className="text-orange-500 font-black tracking-widest text-lg mb-4">
//               THE GROUP VOTED
//             </Text>

//             {(() => {
//               const winner = players.find(
//                 (p: any) => p.id === roundResults?.winnerId
//               );
//               const winnerName = winner?.username || winner?.name || "Nobody";

//               return (
//                 <>
//                   <View className="w-32 h-32 rounded-full bg-gradient-to-tr from-orange-500 to-red-600 items-center justify-center border-4 border-white/20 shadow-2xl mb-6">
//                     <Text className="text-white font-black text-5xl">
//                       {winnerName[0]}
//                     </Text>
//                   </View>
//                   <Text className="text-white font-black text-4xl mb-1">
//                     {winnerName}
//                   </Text>
//                   <Text className="text-white/60 text-lg">
//                     received {roundResults?.votes || 0} votes
//                   </Text>
//                 </>
//               );
//             })()}
...
//           <View className="w-full bg-white/5 border border-white/10 p-6 rounded-2xl items-center">
//             <MaterialCommunityIcons
//               name="glass-mug-variant"
//               size={32}
//               color="white"
//             />
//             <Text className="text-white font-black text-2xl mt-2 uppercase text-center">
//               Drink!
//             </Text>
//           </View>

//           {isHost && (
//             <View className="absolute bottom-0 w-full pt-4">
//               <TouchableOpacity
//                 onPress={() => sendGameAction("next_reveal")} // Changed from next_question
//                 className="bg-orange-600 w-full py-4 rounded-xl flex-row items-center justify-center shadow-lg"
//               >
...
//           >
//             <Text className="text-white/50 text-center text-sm mb-6 font-medium italic mt-8">
//               "{currentQuestionText}"
//             </Text>
...
//               Object.values(votesMap).forEach((targetId: any) => {
...
//               maxVotes = winnerVotes; // For progress bars
...
//                     received {winnerVotes} votes
//                   </Text>

//                   <View className="w-full bg-red-500/20 border border-red-500/40 p-4 rounded-2xl items-center flex-row justify-center gap-3 mb-8">
//                     <MaterialCommunityIcons
//                       name="glass-mug-variant"
//                       size={28}
//                       color="#ef4444"
//                     />
//                     <Text className="text-red-400 font-black text-xl uppercase tracking-widest">
//                       Drink!
//                     </Text>
//                   </View>
...
//                               <Text
//                                 className={`font-bold text-sm ${isWinner ? "text-orange-500" : "text-white"}`}
//                               >
//                                 {player.username}
//                               </Text>
//                               {isWinner && (
...
//                             <View
//                               className={`h-full rounded-full ${isWinner ? "bg-orange-500" : "bg-white/20"}`}
...
//           </Text>
//           <TouchableOpacity
//             onPress={() => leaveGame()} // Or logic to reset game
