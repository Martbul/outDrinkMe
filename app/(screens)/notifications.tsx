...
// ============================================================================
// COMPONENT: Compact Segmented Control
// ============================================================================
  ...
  return (
    <View className="mx-16 mb-4 mt-2 h-10 bg-[#1A1A1A] rounded-full border border-white/[0.1] p-1 flex-row relative">
      ...
      >
        <Text
          className={`text-[11px] font-black tracking-wide ${
            selected === "unread" ? "text-black" : "text-white/40"
          }`}
        >
          UNREAD
        </Text>
        {/* FIX: Ensure we don't render '0' by checking > 0 first */}
        {(badges?.unread ?? 0) > 0 && (
          <View
          ...
          >
            <Text
              className={`text-[9px] font-bold ${
                selected === "unread" ? "text-black" : "text-orange-500"
              }`}
            >
              {badges?.unread}
            </Text>
      ...
      >
        <Text
          className={`text-[11px] font-black tracking-wide ${
            selected === "all" ? "text-black" : "text-white/40"
          }`}
        >
          ALL
        </Text>
    ...
    >
      ...
      <View className="flex-1">
        <View className="flex-row justify-between items-start mb-1">
          ...
          {isUnread && (
            <View className="w-2 h-2 rounded-full bg-orange-600 mt-1.5" />
          )}
        </View>

        <Text
          className="text-white/40 text-xs font-medium leading-4 mb-1"
          numberOfLines={2}
        >
          {notification.body || ""}
        </Text>
...
// ============================================================================
// MAIN SCREEN: NotificationsScreen
// ============================================================================
  ...
  return (
    <View className="flex-1 bg-black">
      ...
      <View
        ...
        className="z-10 bg-black pb-2 border-b border-white/[0.05]"
      >
          <NestedScreenHeader title="Notifications" eyebrow="TIPSY" />
          {/* FIX: Check if > 0 explicitly to avoid '0' text error */}
        ...
        <CompactSegmentedControl
          selected={filter}
          onSelect={setFilter}
          badges={{ unread: unreadNotificationCount }}
        />
      </View>
