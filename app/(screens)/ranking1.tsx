    ...
    <View className="flex-1 bg-black" style={{ paddingTop: insets.top }}>
      ...
      <View className="px-4 mb-4">
        <View className="flex-row bg-white/[0.05] p-1 rounded-xl border border-white/[0.1]">
          <TouchableOpacity
            className={`flex-1 py-3 rounded-lg items-center ${activeTab === "friends" ? "bg-orange-600 shadow-md" : "bg-transparent"}`}
            onPress={() => handleTabChange("friends")}
          >
            <Text
              className={`font-black tracking-wider text-xs ${activeTab === "friends" ? "text-black" : "text-white/50"}`}
            >
              FRIENDS
            </Text>
          </TouchableOpacity>
